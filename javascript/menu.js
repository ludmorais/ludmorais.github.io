...
const menuHTML = `
  ...
  <div class="menu-list">
    <ul>
      ...
      <li class="container-menu-link"><a href="index.html" class="menu-link">About Me</a></li>
      <li class="container-menu-link"><a href="index.html" class="menu-link">Contact</a></li>
    </ul>
